...
# ===============================
# 9. Heatmap of Genetic Distances
# ===============================
plt.figure(figsize=(12,10))
sns.heatmap(
    distance_df,
    cmap="viridis",
    xticklabels=encoded_df.index,
    yticklabels=encoded_df.index
)
plt.title("Genetic Distance Heatmap (All Markers)")
plt.tight_layout()
plt.savefig("genetic_distance_heatmap.png", dpi=300)
plt.show()
...
print("- genetic_distance_heatmap.png")
